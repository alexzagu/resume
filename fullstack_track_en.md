# Full Stack Track English Resume
...
* **EasyBroker — Senior Full Stack Engineer, 2025**
  * Built a partner webhook system enabling real-time synchronization of thousands of property listings and related records with external partners
  * Increased flyer usage by implementing customizable property-flyer generation in the Rails app
  * Simplified Chrome extension UX by removing the API-key requirement from authentication
  * Improved customer support workflows by building user-identification tooling into the Chrome extension
* **Permi — Full Stack Engineer (Co-Founder), 2024–2025**
  * Architected and deployed a Rails application across separate staging and production environments on GCP, containerized with Docker and backed by a dedicated SQL database
  * Built a CI/CD pipeline with Cloud Build and GitHub Actions to automate testing and deployment
...
* **Chalk & Chickpeas — https://chalkandchickpeas.com**
  * Designed and built a custom Ruby on Rails blogging engine and CMS from scratch, deployed via Kamal to a self-managed Hetzner VPS
  * Implemented SEO infrastructure including JSON-LD structured data, Open Graph tags, and sitemap caching middleware to improve search indexation
  * Built internal analytics and reporting using Blazer to track traffic and content performance
